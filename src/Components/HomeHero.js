  ...
  return (
    <>
      <div className="hero-background">
        <div className="row">
          <div className="col-sm-10 display-6 mt-lg-4 ps-lg-5">
            <h1 className="ps-lg-5 ps-md-4 ps-sm-2 ps-3">
      ...
      <div className="d-flex justify-content-center my-5">
        <h3 className="display-6 ps-sm-5 ps-5">
            ...
            >
              ...
              >
                <span aria-hidden="true">
                  <img src="images/LeftArrow.png" className="logo-btn" />
                </span>
              ...
              >
                <span aria-hidden="true">
                  <img src="images/RightArrow.png" className="logo-btn" />
                </span>
      ...
      <div className="d-flex justify-content-around my-4">
        <p className="display-4 mt-md-3 mt-sm-4 mt-4 explore-text">
