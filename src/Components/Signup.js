...
const Signup = () => {
    ...
    const handleSubmit= (e) =>
    {
      ...
      const respone=axios.post('/sigin',{name,email,password})
        ...
        <>
            ...
            <div className="form-bg">
                <div className="container-fluid py-lg-5 px-lg-5 py-md-5 px-md-5">
                    <div className="row my-lg-5 mx-lg-5 my-md-5 mx-md-5 form-inner-container rounded-5 mx-2 border" data-aos="flip-down" data-aos-duration="1000">
                        <div className="col-md-6 px-md-5 col-10 ms-md-auto ms-5">
                            <div className="d-flex justify-content-around mt-md-5 mt-lg-5 mt-3">
                                <Link to="/login" className="default-link-removed"><h3>Login</h3></Link>
                                <h3 className="signup-underline">Signup</h3>
                            </div>
                            <form onSubmit={handleSubmit}>
                            <div className="mt-lg-5 px-lg-5 mt-md-4 mt-3 px-md-auto px-md-0 px-sm-5">
                                <input type="text" className="form-control border border-dark py-2" id="nameInput" placeholder="Enter Your Name" value={name} onChange={(e) => setName(e.target.value)}/>
                            </div>
                                ...
                                <div className=" mt-lg-4 px-lg-5 mt-md-4 mt-4 px-md-0 px-sm-5">
                                    <input type="password" className="form-control border border-dark py-2" id="exampleInputPassword1" placeholder="enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
                                </div>
                                <div className="d-flex justify-content-around mt-lg-5 mb-lg-5 mt-md-4 mb-md-5 mt-4 mb-2">
                                <div>
                                    <button className="btn me-3 text-white px-4 login-signup-button" type="submit"><strong>signup</strong></button>
                                </div>
                            </div>
                            </form>
