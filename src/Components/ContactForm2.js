  ...
  AOS.init();
    return (
        <>
            ...
            <div className="container-fluid contact-container container-bg-img" id="contactFormSection">
        <div className="row d-flex justify-content-end pe-5">
          <div className="col-lg-6 col-md-10 col-sm-11 col-11 contact-form-bg my-5 rounded-4" data-aos="flip-left" data-aos-duration="1000">
