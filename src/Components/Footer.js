...
import {Facebook,Instagram,WhatsApp,Email,LinkedIn,Share,Twitter,Phone} from '@mui/icons-material';
        ...
        <>
            <div className="container-fluid footer-container">
                <div className="row">
                    ...
                    <div className="col-lg-6 ms-lg-5 my-5" data-aos="zoom-in-up" data-aos-duration="1000">
